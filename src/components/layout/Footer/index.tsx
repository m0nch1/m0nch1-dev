      ...
      <footer>
        <div class="flex flex-col md:flex-row justify-between items-center border-t border-b gap-4 py-4">
          ...
          <div class="flex gap-4">
            <a href="https://twitter.com/m0nch12" target="_blank" class="text-gray-400 hover:text-gray-500 active:text-gray-600 transition duration-100">
            ...
            <a href="https://github.com/m0nch1" target="_blank" class="text-gray-400 hover:text-gray-500 active:text-gray-600 transition duration-100">
              <svg class="w-5 h-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="text-gray-400 text-sm text-center py-4">© 2022 - m0nch1</div>
      </footer>
    </div>
  )
}
